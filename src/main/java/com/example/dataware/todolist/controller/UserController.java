...
import com.example.dataware.todolist.service.UserService;
...
public class UserController {
    ...
    @GetMapping()
    public ResponseEntity<SuccessResponse<UserResponse>> findOne(@AuthenticationPrincipal JwtPayload jwtPayload) {
